                    ...
                    <div className='flex '>
                        <div className='bg-white rounded-sm '>
                            <svg width="20" height="20" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.85986 1V1.99999" stroke="#00AAA1" strokeLinecap="round" strokeLinejoin="round" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M10.8599 3L10.3599 3.5L10.8596 3.00022L10.8599 3Z" fill="#00AAA1" />
                                <path d="M10.8599 3L10.3599 3.5" stroke="#00AAA1" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M12.8599 7H11.8599" stroke="#00AAA1" strokeLinecap="round" strokeLinejoin="round" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M10.8599 11L10.3599 10.5L10.8596 10.9998L10.8599 11Z" fill="#00AAA1" />
                                <path d="M10.8599 11L10.3599 10.5" stroke="#00AAA1" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M6.85986 13V12" stroke="#00AAA1" strokeLinecap="round" strokeLinejoin="round" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M2.85992 11L3.35992 10.5L2.86015 10.9998L2.85992 11Z" fill="#00AAA1" />
                                <path d="M2.85992 11L3.35992 10.5" stroke="#00AAA1" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M0.859924 7H1.85992" stroke="#00AAA1" strokeLinecap="round" strokeLinejoin="round" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M2.85992 3L3.35992 3.5L2.86015 3.00022L2.85992 3Z" fill="#00AAA1" />
                                <path d="M2.85992 3L3.35992 3.5" stroke="#00AAA1" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M6.85989 10.4284C8.7533 10.4284 10.2884 8.89326 10.2884 6.99984C10.2884 5.10642 8.7533 3.57129 6.85989 3.57129C4.96647 3.57129 3.43134 5.10642 3.43134 6.99984C3.43134 8.89326 4.96647 10.4284 6.85989 10.4284Z" stroke="#00AAA1" strokeWidth="1.2" strokeLinejoin="round" />
                            </svg>
                        </div>
