...
const FeatureNewsCard = () => {
    return (
        <div className='flex gap-5 w-full text-black p-5'>
            <div >
                <button className='bg-[#DFF1F0] p-[1px] rounded font-semibold text-[12px] text-[#666666]'>
                    Travel
                </button>
                <h2 className='font-semibold text-3xl mb-6 mt-2'>Set video playback speed
                    with javascript</h2>
                <img alt="news" className="object-cover object-center rounded" src="https://dummyimage.com/450x250" />
                ...
                <div className='w-[90%] flex mt-2'>
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolorum omnis repellendus dolores. Officia nostrum, quod, libero tempora quam inventore quos assumenda ipsum temporibus quibusdam ipsa cum dolorem sapiente. At, accusamus.
                </div>
            </div>
            <div >
                <button className='bg-[#DFF1F0] p-[1px] rounded font-semibold text-[12px] text-[#666666]'>
