            ...
            <React.Fragment key={index}>
                <div className='flex flex-col md:flex-row gap-4 mt-4'>
                    <div className='flex-shrink-0'>
                        <img className='rounded-lg w-full h-auto max-w-xs md:max-w-sm' src="https://dummyimage.com/250x180" alt="" />
                    </div>
                    <div className='flex-1'>
                        ...
                        <p className="text-sm text-[#555555] font-medium mt-4">Did you come here for something in particular or just general Riker-bashing? And blowing into maximum warp</p>
                    </div>
                </div>
                {index === 3 && (
